...
We previously learned how to graphically depict the relationship between two qualitative variables (@sec-comparing-distributions). To make a comparison that includes a significance test, we will need to use the chi square distribution, together with a contingency table.
...
![Chi Square distributions with 2, 4, and 6 degrees of freedom.](Images/Ch9/chisquare.png){#fig-chisquare}
